...
**議論進行度チェック（discourse-freshness.md活用）:**
候補トピックを `common/discourse-freshness.md` の議論進行度マップと照合し、飽和度がmainstream以降のトピックは優先度を下げる。
...
**【共通ルール適用（SKILL.mdフロー ステップ2で読み込み済み）】**
