...
|--------|--------|------------|---------|------|-----------|
| 1 | engagement | 23.0 | 86 | 5 | W-Score最高。深い反応を生むが拡散力は弱い |
| 2 | bip | 18.0 | 450 | 8 | W-Score上位。拡散力・反応とも高パフォーマンス |
| 3 | opinion | 14.4 | 234 | 10 |  |
| 4 | other | 9.4 | 160 | 2 | データ不足（2件） |
| 5 | how-to | 8.1 | 387 | 2 | データ不足（2件） |
| 6 | ai_news | 6.5 | 377 | 11 | W-Score下位 |
| 7 | quote_rt | 1.1 | 897 | 2 | データ不足（2件） |

### 独自性の効果

独自性4-5は平均W-Score 11.7、独自性1-2は12.7（独自性と反応は比例していない）
...
ニュース系は飽和度'early'が最もW-Score高い（6.6）

### レピュテーションリスク

リスク3以上: 1件/40件（2.5%）— 煽り・根拠不足・二次利用感に注意
