...
- **投稿アカウント**: @sena_09_04（表向き）
- **API連携アカウント**: @SundererD27468（user_id: `1805557649876172801`）
...
| `discourse-freshness-updater` | 毎週日曜 20:00 | Grok APIで議論進行度マップ（discourse-freshness.md）を自動更新（手動ワークフロー。専用スクリプト未作成） | ~5-7円 |
