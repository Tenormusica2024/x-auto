...
| 種別 | 条件 | スキル | 文字数 |
|------|------|--------|--------|
| **短文ツイート** | ネタ提供済み。ニュース速報・知見共有・BIP | `skills/generate-tweet/PROMPT.md` | 140字以内 |
...
| `skills/like-back/SKILL.md` | 「いいね返し」「like back」「2倍返し」 | API収集+CiCいいね返し（collect_likers.py→CiC実行） |
